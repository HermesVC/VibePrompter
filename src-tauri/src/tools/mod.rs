...
pub fn list_workspace_tools() -> Vec<ToolDefinition> {
    vec![
        ...
        workspace::write_file::tool_definition(),
        workspace::run_verify::tool_definition(),
    ]
}
...
pub async fn execute_tool(
    ...
    match name {
        ...
        workspace::WRITE_FILE => workspace::write_file::execute(ctx, arguments).await,
        workspace::RUN_VERIFY => workspace::run_verify::execute(ctx, arguments).await,
